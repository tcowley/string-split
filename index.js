exports = module.exports = function stringSplit(str, width) {
    ...
    words.forEach(function(word) {
        ...
        // CASE 3: append a big word that will be split 
        ...
        // - resulting split ensures at least 3 characters on both lines
            ...
            // fill the rest of the line, with room for a trailing '-'
            offset = width - line.length - 2; 
            // edge case: there must be at least 3 chars after the split
        ...
        //
        // STEP 2: wrap all really long words onto additional lines
        //
